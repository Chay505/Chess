...
**Hero Section Layout (ChessLAB Branding):**
...
- Brand name: ChessLAB displayed consistently
...
**Color Palette (ChessLAB Branding):**
- Primary: `#4D6C58` (forest green for CTA button and headings)
- Secondary: `#B2C0B6` (sage green for hover states)
- Background: `#F6F1EC` (cream) or `#FFFFFF` (white)
- Neutral: `#D7D4CF` (light gray for borders/dividers)
- Text: `#4D6C58` (forest green for headings), gray-700 for body text
  ...
  return (
    <section className="bg-chesslab-cream py-16 px-6 md:py-24 md:px-12">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-chesslab-forest mb-4">
            {t('headline')}
          </h1>
          ...
          <button
            ...
            className="bg-chesslab-forest text-white px-8 py-4 rounded-lg font-medium hover:bg-chesslab-sage transition"
          >
            {t('cta')}
          </button>
        </div>
...
- **Created:** `public/images/Final.jpg` - Professional chess instructor photo (in-action shot)
